...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($queryCek) == 0) {
        $sql = mysqli_query($koneksi, "UPDATE `studio` SET `nama_studio`= '$nama_studio' WHERE `id_studio` = '$id'");
        ...
        $_SESSION['message'] = 'Nama studio sudah ada, data gagal diubah';
        $_SESSION['title'] = 'Data Studio';
        $_SESSION['type'] = 'error';
    }
...
<div class="col-6">
    <div class="card card-accent-success">
        <div class="card-header"><strong>Ubah Studio</strong></div>
        <div class="card-body">
            <form action="#" method="post" data-toggle="validator" role="form">
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" id="nama_studio" name="nama_studio" value="<?= $getdata['nama_studio'] ?>" data-required-error="Data tidak boleh kosong" required>
